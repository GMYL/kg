...
import hb.kg.system.dao.ModuleDao;
...
public class ModuleService extends BaseCRUDService<HBModule> {
    ...
    public List<HBModuleVisitInfo> getAllRecordingModule() {
        return moduleDao.findAll()
                        .stream()
                        .filter(item -> item.getRecord() != null && item.getRecord())
                        .map(item -> new HBModuleVisitInfo().fromHBModule(item))
