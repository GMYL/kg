...
public class AliMessageUtil {
    ...
    static final String accessKeyId = "LTAIvbG92LjLYTHs";
    static final String accessKeySecret = "afsyUfLObq12LHRyik5bwHRqh7ZaCu";
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        // 发短信
        SendSmsResponse response = sendSms("18503850119", "老王", "我问的问题是什么？");
