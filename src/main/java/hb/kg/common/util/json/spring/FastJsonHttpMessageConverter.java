 ...
 *        </p>
 *        Jsonp with property filter:
 *        MappingFastJsonValue[FastJsonContainer[Object]]
 */
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object>//
    ...
    /*
     * @see
     * org.springframework.http.converter.GenericHttpMessageConverter#read(java.lang
     * .reflect.Type, java.lang.Class, org.springframework.http.HttpInputMessage)
     */
    ...
    public void write(Object o,
        ...
        super.write(o, contentType, outputMessage);// support StreamingHttpOutputMessage in
                                                   // spring4.0+
    ...
    private Object readType(Type type,
                            HttpInputMessage inputMessage) {
        try {
            ...
            throw new HttpMessageNotReadableException("JSON parse error: " + ex.getMessage(),
                                                      ex,
                                                      inputMessage);
        } catch (IOException ex) {
            throw new HttpMessageNotReadableException("I/O error while reading input message",
                                                      ex,
                                                      inputMessage);
        }
    }
