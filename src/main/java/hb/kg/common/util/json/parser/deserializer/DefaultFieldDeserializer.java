...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public DefaultFieldDeserializer(ParserConfig config,
                                    Class<?> clazz,
                                    FieldInfo fieldInfo) {
    ...
    public ObjectDeserializer getFieldValueDeserilizer(ParserConfig config) {
        if (fieldValueDeserilizer == null) {
            ...
            if (annotation != null && annotation.deserializeUsing() != Void.class) {
                ...
                fieldValueDeserilizer = config.getDeserializer(fieldInfo.fieldClass,
                                                               fieldInfo.fieldType);
            }
        }
    ...
    public void parseField(DefaultJSONParser parser,
        ...
        if (fieldValueDeserilizer instanceof JavaBeanDeserializer
            ...
            value = javaBeanDeser.deserialze(parser,
                                             fieldType,
                                             fieldInfo.name,
    ...
    public void parseFieldUnwrapped(DefaultJSONParser parser,
                                    Object object,
                                    Type objectType,
                                    Map<String, Object> fieldValues) {
