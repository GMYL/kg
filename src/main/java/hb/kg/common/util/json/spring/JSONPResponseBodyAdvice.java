...
import hb.kg.common.util.json.spring.annotation.ResponseJSONP;

/**
 * Created by SongLing.Dong on 7/22/2017.
 * <p>
 * Wrap with the return object from method annotated by
 * <code>@ResponseJSONP</code> in order to be serialized into jsonp format.
 * </p>
 * <p>
 * <p>
 ...
 *        <p>
 *        In Spring 3.x, use method directly return a <code>JSONPObject</code>
 *        instead.
 *        </p>
 */
...
public class JSONPResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter returnType,
        ...
        return FastJsonHttpMessageConverter.class.isAssignableFrom(converterType)
                && (returnType.getContainingClass().isAnnotationPresent(ResponseJSONP.class)
    ...
    /**
     * Return the content type to set the response to. This implementation always
