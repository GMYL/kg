...
import hb.kg.common.util.json.spring.annotation.FastJsonFilter;
import hb.kg.common.util.json.spring.annotation.FastJsonView;

/**
 * A convenient base class for {@code ResponseBodyAdvice} implementations that
 * customize the response before JSON serialization with
 * {@link FastJsonHttpMessageConverter4}'s concrete subclasses.
 * <p>
 */
@Order
@ControllerAdvice
public class FastJsonViewResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public FastJsonContainer beforeBodyWrite(Object body,
    ...
    private FastJsonContainer getOrCreateContainer(Object body) {
        return (body instanceof FastJsonContainer ? (FastJsonContainer) body
                : new FastJsonContainer(body));
    }

    protected void beforeBodyWriteInternal(FastJsonContainer container,
