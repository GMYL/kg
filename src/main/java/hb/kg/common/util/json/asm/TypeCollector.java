...
public class TypeCollector {
    ...
    private static final Map<String, String> primitives = new HashMap<String, String>() {
        private static final long serialVersionUID = 5588613502953544466L;
        {
            put("int", "I");
            put("boolean", "Z");
            put("byte", "B");
    ...
    public TypeCollector(String methodName,
    ...
    protected MethodCollector visitMethod(int access,
                                          String name,
                                          String desc) {
        if (collector != null) {
            return null;
        ...
        ASMType[] argTypes = ASMType.getArgumentTypes(desc);
        int longOrDoubleQuantity = 0;
        for (ASMType t : argTypes) {
    ...
    private boolean correctTypeName(ASMType type,
