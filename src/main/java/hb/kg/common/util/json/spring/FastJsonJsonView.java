...
public class FastJsonJsonView extends AbstractView {
    ...
    /**
     * Filters out undesired attributes from the given model. The return value can
     * be either another {@link Map}, or a single value object.
     * <p>
     * Default implementation removes {@link BindingResult} instances and entries
     * not included in the {@link #setRenderedAttributes(Set) renderedAttributes}
     * property.
