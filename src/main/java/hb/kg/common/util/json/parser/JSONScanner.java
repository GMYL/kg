...
public final class JSONScanner extends JSONLexerBase {
    ...
    protected final void copyTo(int offset,
                                int count,
                                char[] dest) {
        text.getChars(offset, offset + count, dest, 0);
    }

    static boolean charArrayCompare(String src,
                                    int offset,
                                    char[] dest) {
    ...
    private boolean scanISO8601DateIfMatch(boolean strict,
                                           int rest) {
        if (rest < 8) {
            return false;
        }
    ...
    protected void setTime(char h0,
                           char h1,
                           char m0,
                           char m1,
                           char s0,
    ...
    protected void setTimeZone(char timeZoneFlag,
                               char t0,
                               char t1) {
    ...
    private boolean checkTime(char h0,
                              char h1,
                              char m0,
                              char m1,
                              char s0,
    ...
    private void setCalendar(char y0,
                             char y1,
                             char y2,
                             char y3,
                             char M0,
    ...
    static boolean checkDate(char y0,
                             char y1,
                             char y2,
                             char y3,
                             char M0,
    ...
    public java.util.Date scanDate(char seperator) {
        ...
        if (ch == '"') {
            ...
            dateVal = new java.util.Date(millis);
        } else if (ch == 'n' && charAt(index++) == 'u' && charAt(index++) == 'l'
                && charAt(index++) == 'l') {
            dateVal = null;
            ch = charAt(index);
            bp = index;
    ...
    protected final void arrayCopy(int srcPos,
                                   char[] dest,
                                   int destPos,
                                   int length) {
