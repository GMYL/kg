...
import hb.kg.common.util.json.parser.deserializer.ParseProcess;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static Object parse(byte[] input,
        ...
        DefaultJSONParser parser = new DefaultJSONParser(chars,
                                                         position,
     ...
     *        example, to get the type for {@code Collection<Foo>}, you should use:
     * 
     *        <pre>
    ...
    @SuppressWarnings("unchecked")
    public static <T> T parseObject(String input,
                                    Type clazz,
                                    ParseProcess processor,
                                    Feature... features) {
    ...
    public static byte[] toJSONBytes(Object object,
                                     ...
                                     int defaultFeatures,
                                     SerializerFeature... features) {
        return toJSONBytes(IOUtils.UTF8,
                           object,
                           config,
                           filters,
                           dateFormat,
     ...
     */
    public static void writeJSONStringTo(Object object,
                                         Writer writer,
                                         SerializerFeature... features) {
    ...
    public static <T> T toJavaObject(JSON json,
                                     Class<T> clazz) {
    ...
    public static <T> void handleResovleTask(DefaultJSONParser parser,
                                             T value) {
        parser.handleResovleTask(value);
    }
