...
import hb.kg.common.util.json.serializer.FieldSerializer;
...
public class JSONPath implements JSONAware {
    private static ConcurrentMap<String, JSONPath> pathCache = new ConcurrentHashMap<String, JSONPath>(128,
                                                                                                       0.75f,
                                                                                                       1);
    ...
    public Object extract(DefaultJSONParser parser) {
        ...
        for (int i = 0; i < segments.length; ++i) {
            ...
            if (!last) {
                ...
                if (segment instanceof PropertySegment && ((PropertySegment) segment).deep
    ...
    public boolean containsValue(Object rootObject,
                                 Object value) {
     ...
     * @param rootObject Can be a map or custom object. Array and Collection are not
     *        supported.
    ...
    public void arrayAdd(Object rootObject,
                         Object... values) {
        ...
        if (resultClass.isArray()) {
            ...
            Object descArray = Array.newInstance(resultClass.getComponentType(),
        ...
        if (lastSegment instanceof PropertySegment) {
            ...
            if (parentObject instanceof Collection) {
                if (segments.length > 1) {
                    ...
                    if (parentSegment instanceof RangeSegment
                            || parentSegment instanceof MultiIndexSegment) {
    ...
    public static Object eval(Object rootObject,
                              String path) {
     ...
     * @return Set of keys, or <code>null</code> if not supported.
     */
    public static Set<?> keySet(Object rootObject,
                                String path) {
        JSONPath jsonpath = compile(path);
        Object result = jsonpath.eval(rootObject);
    ...
    public static void arrayAdd(Object rootObject,
                                String path,
                                Object... values) {
        JSONPath jsonpath = compile(path);
    ...
    public static boolean remove(Object root,
                                 String path) {
        JSONPath jsonpath = compile(path);
     ...
     * @return
     */
    public static Object extract(String json,
                                 String path,
                                 ParserConfig config,
                                 int features,
    ...
    private static void paths(Map<Object, String> values,
        ...
        if (p != null) {
            boolean basicType = javaObject instanceof String || javaObject instanceof Number
                    || javaObject instanceof Date || javaObject instanceof UUID;
            if (!basicType) {
                return;
            }
        }
    ...
    static class JSONPathParser {
            ...
            while (!isEOF()) {
                ...
                if (ch == '.' || ch == '/') {
                    ...
                    if (c0 == '.' && ch == '.') {
                        next();
                        deep = true;
                        if (path.length() > pos + 3 && ch == '[' && path.charAt(pos) == '*'
                                && path.charAt(pos + 1) == ']' && path.charAt(pos + 2) == '.') {
                            next();
                            next();
                            next();
                            next();
            ...
            if (predicateFlag || IOUtils.firstIdentifier(ch) || ch == '\\' || ch == '@') {
                ...
                if (op == Operator.IN || op == Operator.NOT_IN) {
                    ...
                    for (Object item : valueList) {
                        ...
                        if (isInt && !(clazz == Byte.class || clazz == Short.class
                ...
                if (ch == '\'' || ch == '"') {
                    ...
                    if (op == Operator.RLIKE) {
                        ...
                        if (p0 == -1) {
                            ...
                            filter = new MatchSegement(propertyName,
                                                       startsWithValue,
                                                       endsWithValue,
                                                       containsValues,
                                                       not);
        ...
        Segment buildArraySegement(String indexText) {
            ...
            if (colonIndex != -1) {
                ...
                if (end >= 0 && end < start) {
                    throw new UnsupportedOperationException("end must greater than or equals start. start "
                            + start + ",  end " + end);
                }
                if (step <= 0) {
                    throw new UnsupportedOperationException("step must greater than zero : "
                            + step);
                }
    ...
    interface Segment {
        Object eval(JSONPath path,
                    Object rootObject,
                    Object currentObject);

        void extract(JSONPath path,
    ...
    static class SizeSegment implements Segment {
        ...
        public Integer eval(JSONPath path,
                            Object rootObject,
                            Object currentObject) {
            return path.evalSize(currentObject);
        }

        public void extract(JSONPath path,
                            DefaultJSONParser parser,
                            Context context) {
            throw new UnsupportedOperationException();
        }
    ...
    static class PropertySegment implements Segment {
                    ...
                    if (context.eval) {
                        ...
                        if (context.eval) {
                            if (context.object instanceof List) {
                                @SuppressWarnings("unchecked")
                                List<Object> list = (List<Object>) context.object;
        ...
        public void setValue(JSONPath path,
                             Object parent,
                             Object value) {
            if (deep) {
    ...
    static class MultiPropertySegment implements Segment {
        ...
        public Object eval(JSONPath path,
            ...
            for (int i = 0; i < propertyNames.length; i++) {
                Object fieldValue = path.getPropertyValue(currentObject,
                                                          propertyNames[i],
                                                          propertyNamesHash[i]);
    ...
    static class WildCardSegment implements Segment {
        ...
        public Object eval(JSONPath path,
            ...
            path.deekgetPropertyValues(currentObject, values);
            return values;
        }
        ...
        public void extract(JSONPath path,
            ...
            if (context.eval) {
                ...
                if (deep) {
                    List<Object> values = new ArrayList<Object>();
                    path.deekgetPropertyValues(object, values);
    ...
    static class ArrayAccessSegment implements Segment {
        ...
        public boolean setValue(JSONPath path,
                                Object currentObject,
                                Object value) {
    ...
    static class ValueSegment implements Filter {
        ...
        public ValueSegment(String propertyName,
                            Object value,
                            boolean eq) {
            if (value == null) {
    ...
    static class IntInSegement implements Filter {
        ...
        public IntInSegement(String propertyName,
                             long[] values,
                             boolean not) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class IntBetweenSegement implements Filter {
        ...
        public IntBetweenSegement(String propertyName,
                                  long startValue,
                                  long endValue,
                                  boolean not) {
            this.propertyName = propertyName;
    ...
    static class IntObjInSegement implements Filter {
        ...
        public IntObjInSegement(String propertyName,
                                Long[] values,
                                boolean not) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class StringInSegement implements Filter {
        ...
        public StringInSegement(String propertyName,
                                String[] values,
                                boolean not) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class IntOpSegement implements Filter {
        ...
        public IntOpSegement(String propertyName,
                             long value,
                             Operator op) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class DoubleOpSegement implements Filter {
        ...
        public DoubleOpSegement(String propertyName,
                                double value,
                                Operator op) {
            this.propertyName = propertyName;
            this.value = value;
    ...
    static class RefOpSegement implements Filter {
        ...
        public RefOpSegement(String propertyName,
                             Segment refSgement,
                             Operator op) {
            this.propertyName = propertyName;
        ...
        public boolean apply(JSONPath path,
            ...
            if (refValue instanceof Integer || refValue instanceof Long || refValue instanceof Short
                ...
                if (propertyValue instanceof Integer || propertyValue instanceof Long
                        || propertyValue instanceof Short || propertyValue instanceof Byte) {
                    long longValue = TypeUtils.longExtractValue((Number) propertyValue);
                    switch (op) {
                    case EQ:
                        return longValue == value;
    ...
    static class MatchSegement implements Filter {
        ...
        public MatchSegement(String propertyName,
    ...
    static class RlikeSegement implements Filter {
        ...
        public RlikeSegement(String propertyName,
                             String pattern,
                             boolean not) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class StringOpSegement implements Filter {
        ...
        public StringOpSegement(String propertyName,
                                String value,
                                Operator op) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class RegMatchSegement implements Filter {
        ...
        public RegMatchSegement(String propertyName,
                                Pattern pattern,
                                Operator op) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
    ...
    static class FilterGroup implements Filter {
        ...
        public FilterGroup(Filter left,
                           Filter right,
                           boolean and) {
    ...
    @SuppressWarnings("rawtypes")
    protected Object getArrayItem(final Object currentObject,
                                  int index) {
        if (currentObject == null) {
            return null;
        }
    ...
    public boolean setArrayItem(JSONPath path,
                                Object currentObject,
                                int index,
                                Object value) {
        if (currentObject instanceof List) {
    ...
    @SuppressWarnings("rawtypes")
    public boolean removeArrayItem(JSONPath path,
                                   Object currentObject,
                                   int index) {
        if (currentObject instanceof List) {
            List list = (List) currentObject;
    ...
    @SuppressWarnings("deprecation")
    protected void deekgetPropertyValues(final Object currentObject,
        ...
        if (collection != null) {
            for (Object fieldValue : collection) {
                if (fieldValue == null || ParserConfig.isPrimitive2(fieldValue.getClass())) {
                    ...
                    deekgetPropertyValues(fieldValue, outValues);
                }
            }
            return;
        }
    ...
    @SuppressWarnings("rawtypes")
    static boolean eqNotNull(Number a,
                             Number b) {
    ...
    protected static boolean isInt(Class<?> clazzA) {
        return clazzA == Byte.class || clazzA == Short.class || clazzA == Integer.class
                || clazzA == Long.class;
    }
    ...
    protected Object getPropertyValue(Object currentObject,
                                      String propertyName,
        ...
        if (beanSerializer != null) {
            try {
                return beanSerializer.getFieldValue(currentObject,
                                                    propertyName,
                                                    propertyNameHash,
                                                    false);
            } catch (Exception e) {
                throw new JSONPathException("jsonpath error, path " + path + ", segement "
                        + propertyName, e);
            }
        }
        if (currentObject instanceof List) {
    ...
    protected void deepScan(final Object currentObject,
    ...
    protected void deepSet(final Object currentObject,
                           final String propertyName,
                           long propertyNameHash,
                           Object value) {
        if (currentObject == null) {
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    protected boolean setPropertyValue(Object parent,
                                       String name,
                                       long propertyNameHash,
                                       Object value) {
    ...
    @SuppressWarnings({ "rawtypes" })
    protected boolean removePropertyValue(Object parent,
                                          String name) {
        if (parent instanceof Map) {
    ...
    Set<?> evalKeySet(Object currentObject) {
        ...
        if (currentObject instanceof Map) {
            // For performance reasons return keySet directly, without filtering null-value
            // key.
