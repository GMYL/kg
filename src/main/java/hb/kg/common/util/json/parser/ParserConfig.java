...
import hb.kg.common.util.json.asm.ClassReader;
import hb.kg.common.util.json.asm.TypeCollector;
import hb.kg.common.util.json.parser.deserializer.ASMDeserializerFactory;
import hb.kg.common.util.json.parser.deserializer.ArrayListTypeFieldDeserializer;
...
import hb.kg.common.util.json.parser.deserializer.EnumDeserializer;
import hb.kg.common.util.json.parser.deserializer.FieldDeserializer;
import hb.kg.common.util.json.parser.deserializer.JSONPDeserializer;
import hb.kg.common.util.json.parser.deserializer.JavaBeanDeserializer;
import hb.kg.common.util.json.parser.deserializer.JavaObjectDeserializer;
import hb.kg.common.util.json.parser.deserializer.Jdk8DateCodec;
import hb.kg.common.util.json.parser.deserializer.MapDeserializer;
import hb.kg.common.util.json.parser.deserializer.NumberDeserializer;
...
import hb.kg.common.util.json.parser.deserializer.PropertyProcessable;
import hb.kg.common.util.json.parser.deserializer.PropertyProcessableDeserializer;
import hb.kg.common.util.json.parser.deserializer.SqlDateDeserializer;
import hb.kg.common.util.json.parser.deserializer.StackTraceElementDeserializer;
import hb.kg.common.util.json.parser.deserializer.ThrowableDeserializer;
import hb.kg.common.util.json.parser.deserializer.TimeDeserializer;
import hb.kg.common.util.json.serializer.AtomicCodec;
import hb.kg.common.util.json.serializer.AwtCodec;
import hb.kg.common.util.json.serializer.BigDecimalCodec;
import hb.kg.common.util.json.serializer.BigIntegerCodec;
import hb.kg.common.util.json.serializer.BooleanCodec;
import hb.kg.common.util.json.serializer.CalendarCodec;
import hb.kg.common.util.json.serializer.CharArrayCodec;
import hb.kg.common.util.json.serializer.CharacterCodec;
import hb.kg.common.util.json.serializer.CollectionCodec;
import hb.kg.common.util.json.serializer.DateCodec;
import hb.kg.common.util.json.serializer.FloatCodec;
import hb.kg.common.util.json.serializer.IntegerCodec;
import hb.kg.common.util.json.serializer.JodaCodec;
import hb.kg.common.util.json.serializer.LongCodec;
import hb.kg.common.util.json.serializer.MiscCodec;
import hb.kg.common.util.json.serializer.ObjectArrayCodec;
import hb.kg.common.util.json.serializer.ReferenceCodec;
import hb.kg.common.util.json.serializer.StringCodec;
...
public class ParserConfig {
    ...
    {
        denyHashCodes = new long[] { -8720046426850100497L,
    ...
    private ParserConfig(ASMDeserializerFactory asmFactory,
    ...
    public ObjectDeserializer getDeserializer(Class<?> clazz,
        ...
        if (className.startsWith("java.awt.") //
            ...
            if (!awtError) {
                String[] names = new String[] { "java.awt.Point",
                                                "java.awt.Font",
                                                "java.awt.Rectangle",
                                                "java.awt.Color" };
                try {
        ...
        if (!jodaError) {
            try {
                if (className.startsWith("org.joda.time.")) {
                    String[] names = new String[] { "org.joda.time.DateTime",
    ...
    public static Field getFieldFromCache(String fieldName,
    ...
    public Class<?> checkAutoType(String typeName,
        ...
        final long h3 = (((((BASIC ^ className.charAt(0)) * PRIME) ^ className.charAt(1)) * PRIME)
                ^ className.charAt(2)) * PRIME;
        ...
        boolean autoTypeSupport = this.autoTypeSupport || (features & mask) != 0
        ...
        if (clazz != null) {
            ...
            if (ClassLoader.class.isAssignableFrom(clazz) // classloader is danger
                    || javax.sql.DataSource.class.isAssignableFrom(clazz) // dataSource can load
                                                                          // jdbc driver
