...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public FieldSerializer(Class<?> beanType,
                           FieldInfo fieldInfo) {
        this.fieldInfo = fieldInfo;
        this.fieldContext = new BeanContext(beanType, fieldInfo);
        if (beanType != null && (fieldInfo.isEnum || fieldInfo.fieldClass == long.class
                || fieldInfo.fieldClass == Long.class || fieldInfo.fieldClass == BigInteger.class
    ...
    public void writeValue(JSONSerializer serializer,
        ...
        if (propertyValue == null) {
            ...
            fieldSerializer.write(serializer,
                                  null,
                                  fieldInfo.name,
                                  fieldInfo.fieldType,
                                  fieldFeatures);
        ...
        if (format != null && !(valueSerializer instanceof DoubleSerializer
                || valueSerializer instanceof FloatCodec)) {
            if (valueSerializer instanceof ContextObjectSerializer) {
                ((ContextObjectSerializer) valueSerializer).write(serializer,
                                                                  propertyValue,
                                                                  this.fieldContext);
            } else {
        ...
        if (fieldInfo.unwrapped) {
            if (valueSerializer instanceof JavaBeanSerializer) {
                ...
                javaBeanSerializer.write(serializer,
                                         propertyValue,
                                         fieldInfo.name,
                                         fieldInfo.fieldType,
                                         fieldFeatures,
            ...
            if (valueSerializer instanceof MapSerializer) {
                ...
                mapSerializer.write(serializer,
                                    propertyValue,
                                    fieldInfo.name,
                                    fieldInfo.fieldType,
                                    fieldFeatures,
        ...
        if ((features & SerializerFeature.WriteClassName.mask) != 0
            ...
            ((JavaBeanSerializer) valueSerializer).write(serializer,
                                                         propertyValue,
                                                         fieldInfo.name,
                                                         fieldInfo.fieldType,
                                                         fieldFeatures,
        ...
        valueSerializer.write(serializer,
                              propertyValue,
                              fieldInfo.name,
                              fieldInfo.fieldType,
                              fieldFeatures);
