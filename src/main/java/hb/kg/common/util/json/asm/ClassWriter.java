...
public class ClassWriter {
     ...
     * {@link MethodWriter#next} field. This field stores the first element of this
     * list.
     */
    ...
    public byte[] toByteArray() {
        ...
        int mask = 393216; // Opcodes.ACC_DEPRECATED | ClassWriter.ACC_SYNTHETIC_ATTRIBUTE |
     ...
     *        a {@link Double}, a {@link String} or a {@link ASMType}.
    ...
    Item newConstItem(final Object cst) {
        ...
        } else if (cst instanceof ASMType) {
            ASMType t = (ASMType) cst;
            return newClassItem(t.sort == 10 /* Type.OBJECT */ ? t.getInternalName()
                    : t.getDescriptor());
        } else {
    ...
    Item newFieldItem(final String owner,
        ...
        if (result == null) {
            // put122(9 /* FIELD */, newClassItem(owner).index, newNameTypeItem(name,
            // desc).index);
    ...
    public Item newNameTypeItem(final String name,
                                final String desc) {
