...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static Type getFieldType(final Class<?> clazz,
        ...
        if (fieldType instanceof GenericArrayType) {
            ...
            if (componentType != componentTypeX) {
                Type fieldTypeX = Array.newInstance(TypeUtils.getClass(componentTypeX), 0)
                                       .getClass();
                return fieldTypeX;
            }
            return fieldType;
        ...
        if (fieldType instanceof ParameterizedType) {
            ...
            boolean changed = getArgument(arguments,
                                          typeVariables,
    ...
    private static boolean getArgument(Type[] typeArgs,
                                       TypeVariable[] typeVariables,
                                       Type[] arguments) {
        ...
        for (int i = 0; i < typeArgs.length; ++i) {
            ...
            if (typeArg instanceof ParameterizedType) {
                ...
                if (p_changed) {
                    typeArgs[i] = new ParameterizedTypeImpl(p_typeArg_args,
                                                            p_typeArg.getOwnerType(),
    ...
    private static Type getInheritGenericType(Class<?> clazz,
                                              Type type,
                                              TypeVariable<?> tv) {
        ...
        if (class_gd == clazz) {
            ...
            for (Class<?> c = clazz; c != null && c != Object.class
                    && c != class_gd; c = c.getSuperclass()) {
    ...
    public int compareTo(FieldInfo o) {
        ...
        if (thisDeclaringClass != null && otherDeclaringClass != null
                && thisDeclaringClass != otherDeclaringClass) {
        ...
        if (o.fieldClass.getName().startsWith("java.")
                && !this.fieldClass.getName().startsWith("java.")) {
            return 1;
        }
        if (this.fieldClass.getName().startsWith("java.")
                && !o.fieldClass.getName().startsWith("java.")) {
            return -1;
        }
