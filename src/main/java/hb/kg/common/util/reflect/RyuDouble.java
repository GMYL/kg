...
public final class RyuDouble {
    ...
    static {
        ...
        for (int i = 0; i < 326; i++) {
            ...
            if (i < POW5_SPLIT.length) {
                for (int j = 0; j < 4; j++) {
                    POW5_SPLIT[i][j] = pow.shiftRight(pow5len - 121 + (3 - j) * 31)
                                          .and(mask)
                                          .intValue();
                }
            }
    ...
    public static int toString(double value,
        ...
        if (e2 >= 0) {
            ...
            final int k = 122 + (q == 0 ? 1 : (int) ((q * 23219280L + 10000000L - 1) / 10000000L))
                    - 1;
            final int i = -e2 + q + k;
            ...
            final int[] ints = POW5_INV_SPLIT[q];
            {
                ...
                dv = ((((((((bits00 >>> 31) + bits01 + bits10) >>> 31) + bits02 + bits11) >>> 31)
            ...
            }
            {
                ...
                long bits10 = mHigh * ints[3];
                long bits00 = mLow * ints[3];
                dp = ((((((((bits00 >>> 31) + bits01 + bits10) >>> 31) + bits02 + bits11) >>> 31)
                        + bits03 + bits12) >>> 21) + (bits13 << 10)) >>> actualShift;
            }
            {
                long mHigh = mm >>> 31;
                ...
                long bits10 = mHigh * ints[3];
                long bits00 = mLow * ints[3];
                dm = ((((((((bits00 >>> 31) + bits01 + bits10) >>> 31) + bits02 + bits11) >>> 31)
                        + bits03 + bits12) >>> 21) + (bits13 << 10)) >>> actualShift;
            }
            e10 = q;
            if (q <= 21) {
        ...
        if (dmIsTrailingZeros || dvIsTrailingZeros) {
            ...
            output = dv + ((dv == dm && !(dmIsTrailingZeros && even)) || (lastRemovedDigit >= 5) ? 1
                    : 0);
        } else {
            while (dp / 10 > dm / 10) {
                if ((dp < 100) && scientificNotation) {
